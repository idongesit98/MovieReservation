...
router.post("/:movieId/update", authMiddleware_1.authenticate, (0, authMiddleware_1.authorize)(["ADMIN"]), controller.movieUpdate);
router.delete("/:id", authMiddleware_1.authenticate, authMiddleware_1.authorize, controller.movieDeleted);
router.get("/search", authMiddleware_1.authenticate, (0, authMiddleware_1.authorize)(["ADMIN"]), controller.moviesSearch);
